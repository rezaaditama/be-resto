...
import { createMenuController, deleteMenuController, getAllMenuController, getMenuByIdController, updateMenuController } from "./menu.controller";
...
MenuRouter.patch("/update-menu/:id", authenticateToken, authorizeRole(["CASHIER", "KITCHEN"]), uploadMenuImage.single("image_path"), updateMenuController);
